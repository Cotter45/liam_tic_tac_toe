...
export const WinnerModal = ({
  ...
  return (
    <div className="bg-gray-900/90 z-10 min-h-screen w-full absolute top-0 left-0">
      <div className="w-[90%] h-[250px] rounded-xl bg-[#1f3540] space-y-10 px-6 py-4 mx-auto mt-52 flex items-center justify-center flex-col">
        ...
        <div className="flex items-center justify-center space-x-16">
          <button
            ...
            className="button px-8 rounded-md py-1 bg-[#a8bdc8] hover:bg-[#718087] hover:ring-4 hover:ring-gray-400"
          >
            Quit
          </button>
          <button
